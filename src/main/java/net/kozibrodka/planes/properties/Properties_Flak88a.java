...
import net.kozibrodka.planes.model.ModelFlak88a_125;

public class Properties_Flak88a extends AAGun_properties {

    public Properties_Flak88a(){
        model = new ModelFlak88a_125();
        texture = "SkinAAGunFlak88";
        shortName = "flak88a";
        przedmiot = mod_Planes.flak88a;
