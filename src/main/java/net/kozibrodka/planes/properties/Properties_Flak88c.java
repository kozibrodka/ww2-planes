...
import net.kozibrodka.planes.model.ModelFlak88c_125;

public class Properties_Flak88c extends AAGun_properties {

    public Properties_Flak88c(){
        model = new ModelFlak88c_125();
        texture = "SkinAAGunFlak88";
        shortName = "flak88c";
        przedmiot = mod_Planes.flak88c;
