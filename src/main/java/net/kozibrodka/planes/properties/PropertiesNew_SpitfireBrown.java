...
public class PropertiesNew_SpitfireBrown extends Machine_properties {
    public PropertiesNew_SpitfireBrown()
    {
        name = "Supermarine Spitfire Brown Carmo";
        shortName = "Spitfire2";
        texture = "SkinPlaneSpitfire2";
        modelNew = new ModelSupermarineSpitfire_125();
        przedmiot = mod_Planes.planeNew_Spitfire2;
        maxPropSpeed = 4.5F;
        takeOffSpeed = 3.0F;
        barrelX = -40;
        barrelY = 13;
