...
import net.kozibrodka.planes.model.ModelJU87G_125;
import net.kozibrodka.sdk_api.events.init.ww2Parts;
import net.minecraft.item.ItemBase;
import net.minecraft.item.ItemInstance;

public class PropertiesNew_JU87G extends Machine_properties {
    public PropertiesNew_JU87G()
    {
        name = "Junkers JU 87 Gunbird";
        shortName = "JU87G";
        texture = "SkinPlaneJU87";
        modelNew = new ModelJU87G_125();
        przedmiot = mod_Planes.planeNew_JU87G;
        maxPropSpeed = 4.0F;
        takeOffSpeed = 3.0F;
        barrelX = -41;
        barrelY = 12;
