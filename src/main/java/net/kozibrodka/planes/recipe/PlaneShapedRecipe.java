...
public class PlaneShapedRecipe implements PlaneRecipeTemplate { /// StationRecipe interface
    private int width;
    private int height;
    ...
    public PlaneShapedRecipe(int i, int j, ItemStack[] args, ItemStack arg) {
