...
public class PlanelRecipeTab extends TabWithTexture {
    ...
    public PlanelRecipeTab(Namespace tabCreator, List<Object> recipesComplete, Block tabBlock) {
    ...
    public PlanelRecipeTab(Namespace tabCreator, int slotsPerRecipe, List<Object> recipesComplete, Block tabBlock, String texturePath, int width, int height, int textureX, int textureY, int buttonX, int buttonY, int slotsWidth) {
    ...
    public void updateRecipes(ItemStack filter, Boolean getUses) {
        ...
        if (filter == null) {
            ...
            for (Object o : recipesComplete) {
                if (o instanceof PlaneRecipeTemplate) {
