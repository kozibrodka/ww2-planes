...
public class SdkRenderBulletAircraft  extends EntityRenderer {

    public SdkRenderBulletAircraft()
    {
    }

    public void renderArrow(SdkEntityBulletAircraft sdkentitybullet, double d, double d1, double d2,
                            float f, float f1)
    {
    ...
    public void render(EntityBase entity, double d, double d1, double d2,
                       float f, float f1)
    {
        renderArrow((SdkEntityBulletAircraft)entity, d, d1, d2, f, f1);
    }
}
