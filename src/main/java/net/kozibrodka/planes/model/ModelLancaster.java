...
//        (this.bodyModel[0] = new ModelRendererTurbo(0, 0, this.textureX, this.textureY)).addTrapezoid(-160.0f, -80.0f, -16.0f, 16, 32, 32, 0.0f, -4.0f, 3);
//        this.bodyModel[18] = new ModelRendererTurbo(0, 0, this.textureX, this.textureY);
...
//        this.bodyModel[5].yaw = 3.1415927f; //todo: rotaye
...
//        (this.bodyModel[13] = new ModelRendererTurbo(52, 362, this.textureX, this.textureY)).addShape3D(128.0f, -65.0f, -15.0f, new Shape2D(new Coord2D[] { new Coord2D(0.0, 0.0, 0, 0), new Coord2D(160.0, 16.0, 160, 0), new Coord2D(160.0, 17.0, 160, 1), new Coord2D(0.0, 1.0, 0, 1) }), 30.0f, 160, 1, 322, 30, 0, new float[] { 1.0f, 160.0f, 1.0f, 160.0f });
//        this.bodyModel[13].pitch = 3.1415927f;
...
//        this.bodyModel[14].pitch = 3.1415927f;
...
//        this.bodyModel[15].pitch = 3.1415927f;
//
//
//        (this.bodyModel[19] = new ModelRendererTurbo(this, 0, 279, this.textureX, this.textureY)).addBox(96.0f, 16.0f, -82.0f, 16, 64, 2, 0.0f);
//        this.bodyModel[19].pitch = -1.5707964f;
//        (this.bodyModel[20] = new ModelRendererTurbo(this, 0, 279, this.textureX, this.textureY)).addBox(96.0f, 16.0f, -82.0f, 16, 64, 2, 0.0f);
//        this.bodyModel[20].doMirror(false, true, false);
//        this.bodyModel[20].pitch = -1.5707964f;
//        (this.bodyModel[21] = new ModelRendererTurbo(this, 72, 279, this.textureX, this.textureY)).addBox(96.0f, -128.0f, 80.0f, 16, 64, 2, 0.0f);
//        (this.bodyModel[22] = new ModelRendererTurbo(this, 72, 279, this.textureX, this.textureY)).addBox(96.0f, -128.0f, -82.0f, 16, 64, 2, 0.0f);
//        (this.bodyModel[23] = new ModelRendererTurbo(this, 240, 279, this.textureX, this.textureY)).addBox(64.0f, -96.0f, -15.0f, 64, 1, 30, 0.0f);
//        (this.bodyModel[24] = new ModelRendererTurbo(this, 304, 111, this.textureX, this.textureY)).addTrapezoid(128.0f, -96.0f, -16.0f, 16, 32, 32, 0.0f, -6.0f, 2);
//        (this.bodyModel[26] = new ModelRendererTurbo(this, 0, 113, this.textureX, this.textureY)).addBox(-64.0f, 16.0f, -82.0f, 64, 96, 4, 0.0f);
//        this.bodyModel[26].pitch = -1.5707964f;
//        (this.bodyModel[27] = new ModelRendererTurbo(this, 136, 113, this.textureX, this.textureY)).addTrapezoid(-64.0f, 112.0f, -82.0f, 80, 128, 4, 0.0f, -2.0f, 5);
//        this.bodyModel[27].pitch = -1.5707964f;
//        (this.bodyModel[28] = new ModelRendererTurbo(this, 256, 32, this.textureX, this.textureY)).addTrapezoid(-112.0f, -80.0f, -64.0f, 64, 24, 24, 0.0f, -2.0f, 5);
//        (this.bodyModel[29] = new ModelRendererTurbo(this, 256, 32, this.textureX, this.textureY)).addTrapezoid(-96.0f, -80.0f, -128.0f, 64, 24, 24, 0.0f, -2.0f, 5);
//        (this.bodyModel[30] = new ModelRendererTurbo(this, 408, 24, this.textureX, this.textureY)).addBox(-115.0f, -76.0f, -60.0f, 6, 16, 16, 0.0f);
//        (this.bodyModel[31] = new ModelRendererTurbo(this, 408, 24, this.textureX, this.textureY)).addBox(-99.0f, -76.0f, -124.0f, 6, 16, 16, 0.0f);
//        (this.bodyModel[32] = new ModelRendererTurbo(this, 0, 113, this.textureX, this.textureY)).addBox(-64.0f, 16.0f, -82.0f, 64, 96, 4, 0.0f);
//        this.bodyModel[32].doMirror(false, true, false);
//        this.bodyModel[32].pitch = -1.5707964f;
//        (this.bodyModel[33] = new ModelRendererTurbo(this, 136, 113, this.textureX, this.textureY)).addTrapezoid(-64.0f, 112.0f, -82.0f, 80, 128, 4, 0.0f, -2.0f, 5);
//        this.bodyModel[33].doMirror(false, true, false);
//        this.bodyModel[33].pitch = -1.5707964f;
//        (this.bodyModel[34] = new ModelRendererTurbo(this, 256, 32, this.textureX, this.textureY)).addTrapezoid(-112.0f, -80.0f, 40.0f, 64, 24, 24, 0.0f, -2.0f, 5);
//        (this.bodyModel[35] = new ModelRendererTurbo(this, 256, 32, this.textureX, this.textureY)).addTrapezoid(-96.0f, -80.0f, 104.0f, 64, 24, 24, 0.0f, -2.0f, 5);
//        (this.bodyModel[36] = new ModelRendererTurbo(this, 408, 24, this.textureX, this.textureY)).addBox(-115.0f, -76.0f, 44.0f, 6, 16, 16, 0.0f);
//        (this.bodyModel[37] = new ModelRendererTurbo(this, 408, 24, this.textureX, this.textureY)).addBox(-99.0f, -76.0f, 108.0f, 6, 16, 16, 0.0f);
//
...
//        (this.pitchFlapRightModel[0] = new ModelRendererTurbo(this, 0, 345, this.textureX, this.textureY)).addBox(0.0f, -48.0f, -2.0f, 16, 96, 4, 0.0f);
//        this.pitchFlapRightModel[0].pitch = 1.570796f;
//        this.pitchFlapRightModel[0].setPosition(0.0f, -80.0f, -64.0f);
...
//        this.pitchFlapLeftModel[0].pitch = 1.570796f;
//        this.pitchFlapLeftModel[0].setPosition(112.0f, -81.0f, 48.0f);
//        (this.pitchFlapLeftModel[1] = new ModelRendererTurbo(this, 0, 345, this.textureX, this.textureY)).addBox(0.0f, -48.0f, -2.0f, 16, 96, 4, 0.0f);
//        this.pitchFlapLeftModel[1].doMirror(false, true, false);
//        this.pitchFlapLeftModel[1].pitch = 1.570796f;
//        this.pitchFlapLeftModel[1].setPosition(0.0f, -80.0f, 64.0f);
//        (this.pitchFlapRightModel[1] = new ModelRendererTurbo(this, 36, 279, this.textureX, this.textureY)).addBox(0.0f, -32.0f, -1.0f, 16, 64, 2, 0.0f);
//        this.pitchFlapRightModel[1].pitch = 1.570796f; //tODO: rotate
//        this.pitchFlapRightModel[1].setPosition(112.0f, -81.0f, -48.0f);
...
//        final ModelRendererTurbo[] prop =  new ModelRendererTurbo[]{new ModelRendererTurbo(40, 345, this.textureX, this.textureY), new ModelRendererTurbo(40, 345, this.textureX, this.textureY), new ModelRendererTurbo(40, 345, this.textureX, this.textureY)};
