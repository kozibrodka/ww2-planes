...
public class ModelBiplane_125 extends ModelPlaneNew
{

    public ModelBiplane_125()
    {
        char c = '\200';
        byte byte0 = 64;
        propellerModels = new ModelRendererTurbo[1][3];
        propellerModels[0][0] = new ModelRendererTurbo(this, 56, 8, c, byte0);
        propellerModels[0][1] = new ModelRendererTurbo(this, 56, 8, c, byte0);
        propellerModels[0][2] = new ModelRendererTurbo(this, 56, 8, c, byte0);
        ...
        yawFlapModel[0] = new ModelRendererTurbo(this, 104, 0, c, byte0);
        yawFlapModel[0].addBox(0.0F, 0.0F, 0.0F, 10, 10, 2, 0.0F);
        yawFlapModel[0].setPosition(40F, -12F, -1F);
        pitchFlapLeftModel = new ModelRendererTurbo[1];
        pitchFlapLeftModel[0] = new ModelRendererTurbo(this, 104, 0, c, byte0);
        ...
        pitchFlapRightModel[0] = new ModelRendererTurbo(this, 104, 0, c, byte0);
        ...
        bodyModel[0] = new ModelRendererTurbo(this, 0, 8, c, byte0);
        bodyModel[1] = new ModelRendererTurbo(this, 0, 0, c, byte0);
        bodyModel[2] = new ModelRendererTurbo(this, 0, 0, c, byte0);
        bodyModel[3] = new ModelRendererTurbo(this, 0, 0, c, byte0);
        bodyModel[4] = new ModelRendererTurbo(this, 0, 0, c, byte0);
        bodyModel[5] = new ModelRendererTurbo(this, 64, 0, c, byte0);
        bodyModel[6] = new ModelRendererTurbo(this, 64, 0, c, byte0);
        bodyModel[7] = new ModelRendererTurbo(this, 64, 0, c, byte0);
        bodyModel[8] = new ModelRendererTurbo(this, 64, 0, c, byte0);
        bodyModel[9] = new ModelRendererTurbo(this, 64, 0, c, byte0);
        bodyModel[10] = new ModelRendererTurbo(this, 56, 15, c, byte0);
        bodyModel[11] = new ModelRendererTurbo(this, 56, 15, c, byte0);
        bodyModel[12] = new ModelRendererTurbo(this, 0, 43, c, byte0);
        bodyModel[13] = new ModelRendererTurbo(this, 44, 0, c, byte0);
        bodyModel[14] = new ModelRendererTurbo(this, 0, 32, c, byte0);
        bodyModel[15] = new ModelRendererTurbo(this, 0, 32, c, byte0);
        bodyModel[16] = new ModelRendererTurbo(this, 0, 32, c, byte0);
        byte byte1 = 24;
        byte byte2 = 6;
        byte byte3 = 20;
        byte byte4 = 4;
        ...
        bodyModel[9].rotateAngleX = -1.570796F;
