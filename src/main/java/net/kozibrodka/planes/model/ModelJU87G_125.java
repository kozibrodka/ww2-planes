...
public class ModelJU87G_125 extends ModelPlaneNew {
    int textureX = 512;
    int textureY = 512;
    ...
    public ModelJU87G_125() {
        ...
        this.bodyModel[25].addTrapezoid(0.0F, 0.0F, 0.0F, 2, 1, 1, 0.0F, -0.4F, 5);
        ...
        this.rightWingModel[7] = new ModelRendererTurbo(this, 0, 340, this.textureX, this.textureY);
        this.rightWingModel[8] = new ModelRendererTurbo(this, 60, 340, this.textureX, this.textureY);
        this.rightWingModel[9] = new ModelRendererTurbo(this, 95, 340, this.textureX, this.textureY);
        this.rightWingModel[10] = new ModelRendererTurbo(this, 160, 340, this.textureX, this.textureY);
        this.rightWingModel[11] = new ModelRendererTurbo(this, 0, 350, this.textureX, this.textureY);
        this.rightWingModel[12] = new ModelRendererTurbo(this, 0, 360, this.textureX, this.textureY);
        this.rightWingModel[13] = new ModelRendererTurbo(this, 205, 340, this.textureX, this.textureY);
        this.rightWingModel[14] = new ModelRendererTurbo(this, 205, 354, this.textureX, this.textureY);
        ...
        this.rightWingModel[7].addTrapezoid(0.0F, 0.0F, 0.0F, 26, 6, 2, 0.0F, -0.5F, 5);
        this.rightWingModel[7].setRotationPoint(-3.0F, -22.0F, -39.0F);
        this.rightWingModel[8].addTrapezoid(0.0F, 0.0F, 0.0F, 8, 8, 8, 0.0F, -3.0F, 3);
        this.rightWingModel[8].setRotationPoint(-6.0F, -16.0F, -42.0F);
        this.rightWingModel[9].addBox(0.0F, 0.0F, 0.0F, 21, 8, 8, 0.0F);
        this.rightWingModel[9].setRotationPoint(2.0F, -16.0F, -42.0F);
        this.rightWingModel[10].addTrapezoid(0.0F, 0.0F, 0.0F, 11, 8, 8, 0.0F, -3.5F, 2);
        this.rightWingModel[10].setRotationPoint(23.0F, -16.0F, -42.0F);
        this.rightWingModel[11].addBox(0.0F, 0.0F, 0.0F, 22, 1, 1, 0.0F);
        this.rightWingModel[11].setRotationPoint(-28.0F, -12.5F, -38.5F);
        this.rightWingModel[12].addTrapezoid(0.0F, 0.0F, 0.0F, 10, 2, 2, 0.0F, -0.1F, 2);
        this.rightWingModel[12].setRotationPoint(-38.0F, -13.0F, -39.0F);
        this.rightWingModel[13].addBox(0.0F, 0.0F, 0.0F, 11, 2, 8, 0.0F);
        this.rightWingModel[13].setRotationPoint(10.0F, -13.0F, -34.0F);
        this.rightWingModel[14].addBox(0.0F, 0.0F, 0.0F, 6, 2, 11, 0.0F);
        this.rightWingModel[14].setRotationPoint(10.0F, -13.0F, -53.0F);
        if(this.VarGear) {
        }
        ...
        this.leftWingModel[7] = new ModelRendererTurbo(this, 0, 340, this.textureX, this.textureY);
        this.leftWingModel[8] = new ModelRendererTurbo(this, 60, 340, this.textureX, this.textureY);
        this.leftWingModel[9] = new ModelRendererTurbo(this, 95, 340, this.textureX, this.textureY);
        this.leftWingModel[10] = new ModelRendererTurbo(this, 160, 340, this.textureX, this.textureY);
        this.leftWingModel[11] = new ModelRendererTurbo(this, 0, 350, this.textureX, this.textureY);
        this.leftWingModel[12] = new ModelRendererTurbo(this, 0, 360, this.textureX, this.textureY);
        this.leftWingModel[13] = new ModelRendererTurbo(this, 205, 340, this.textureX, this.textureY);
        this.leftWingModel[14] = new ModelRendererTurbo(this, 205, 354, this.textureX, this.textureY);
        ...
        this.leftWingModel[7].addTrapezoid(0.0F, 0.0F, 0.0F, 26, 6, 2, 0.0F, -0.5F, 5);
        this.leftWingModel[7].setRotationPoint(-3.0F, -22.0F, 37.0F);
        this.leftWingModel[8].addTrapezoid(0.0F, 0.0F, 0.0F, 8, 8, 8, 0.0F, -3.0F, 3);
        this.leftWingModel[8].setRotationPoint(-6.0F, -16.0F, 34.0F);
        this.leftWingModel[9].addBox(0.0F, 0.0F, 0.0F, 21, 8, 8, 0.0F);
        this.leftWingModel[9].setRotationPoint(2.0F, -16.0F, 34.0F);
        this.leftWingModel[10].addTrapezoid(0.0F, 0.0F, 0.0F, 11, 8, 8, 0.0F, -3.5F, 2);
        this.leftWingModel[10].setRotationPoint(23.0F, -16.0F, 34.0F);
        this.leftWingModel[11].addBox(0.0F, 0.0F, 0.0F, 22, 1, 1, 0.0F);
        this.leftWingModel[11].setRotationPoint(-28.0F, -12.5F, 37.5F);
        this.leftWingModel[12].addTrapezoid(0.0F, 0.0F, 0.0F, 10, 2, 2, 0.0F, -0.1F, 2);
        this.leftWingModel[12].setRotationPoint(-38.0F, -13.0F, 37.0F);
        this.leftWingModel[13].addBox(0.0F, 0.0F, 0.0F, 11, 2, 8, 0.0F);
        this.leftWingModel[13].setRotationPoint(10.0F, -13.0F, 42.0F);
        this.leftWingModel[14].addBox(0.0F, 0.0F, 0.0F, 6, 2, 11, 0.0F);
        this.leftWingModel[14].setRotationPoint(10.0F, -13.0F, 23.0F);
        if(this.VarGear) {
        }
