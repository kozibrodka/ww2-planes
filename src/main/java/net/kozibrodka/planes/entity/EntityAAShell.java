...
public class EntityAAShell extends Entity
{
    ...
    public void tick()
    {
        ...
        if(movingobjectposition != null)
        {
            ...
            {
                if(movingobjectposition.entity.damage(owner, damageAA/5))
                {
                    world.playSound(this, "planes:flak", 1.0F, 1.2F / (random.nextFloat() * 0.2F + 0.9F));
                    markDead();
                }
            } else
            {
                ...
                world.playSound(this, "planes:bullethit", 1.0F, 1.2F / (random.nextFloat() * 0.2F + 0.9F));
...
//                ModLoader.getMinecraftInstance().effectRenderer.addEffect(entitysmokefx);
            ...
            {
                Entity entityplane = (Entity)list1.get(k);
