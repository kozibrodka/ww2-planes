...
public class SdkEntityBulletAircraftRocketPanzer extends SdkEntityBullet {
    ...
    public SdkEntityBulletAircraftRocketPanzer(Level world) {
        super(world);
        setSize(0.25F, 0.25F);
    }

    public SdkEntityBulletAircraftRocketPanzer(Level world, double d, double d1, double d2) {
        super(world, d, d1, d2);
        setSize(0.25F, 0.25F);
    }

    public SdkEntityBulletAircraftRocketPanzer(Level world, EntityBase entity, SdkItemGun sdkitemgun, float f, float f1, float f2, float f3,
                                               float f4) {
