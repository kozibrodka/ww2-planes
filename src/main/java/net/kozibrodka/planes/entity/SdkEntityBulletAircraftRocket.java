...
public class SdkEntityBulletAircraftRocket  extends SdkEntityBullet {
    ...
    public SdkEntityBulletAircraftRocket(World world) {
        super(world);
        setBoundingBoxSpacing(0.25F, 0.25F);
    }

    public SdkEntityBulletAircraftRocket(World world, double d, double d1, double d2) {
        super(world, d, d1, d2);
        setBoundingBoxSpacing(0.25F, 0.25F);
    }

    public SdkEntityBulletAircraftRocket(World world, Entity entity, SdkItemGun sdkitemgun, float f, float f1, float f2, float f3,
                                         float f4) {
    ...
    {
        Explosion explosion = new Explosion(world, null, x, (float)y, (float)z, 2F);
        explosion.explode();
